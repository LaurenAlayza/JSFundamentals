...
//2) numbers may follow the above characters, but cannot smoe first
...
Initializations refer to when a variable is assigned  value
...
Let = 'new' keyword for variables (introduced with ES6). Gives you more predictable behavior
const = also 'new', declares unchangeable variablesw
*/
